...
export default function Listbooks() {
    ...
    return (
        <div className='bg-white text-center'>
            <h1 className='border-b-[2px]'>ALL BOOKS</h1><br></br>
            <div className='flex justify-center items-center'>
                <input value={bookname} onChange={(e) => {
                    ...
                    type='search' className='border-[2px] w-[300px] p-[10px]' placeholder='Search book by name'></input>
                {reset && <input onClick={Allbooks} type='reset' value="Reset"></input>}
                {search && <img onClick={SearchBookByName} src='/images/search.png' className='h-[50px] w-[50px]' alt='no'></img>}
            </div>
                ...
                <table className='m-auto'>
                    <thead>
                        <tr>
                            ...
                            <th className='p-[10px] text-center'>Langauge</th>
                        ...
                        </tr>
                        {
                            bookData.map((data, idx) => (
                                ...
                                <tr key={idx} className='hover:bg-pink-50'>
                                    ...
                                    <td className='p-[30px] text-center'>{data.langauge}</td>
                                    <td><img className='h-[100px] w-[100px]' src={`/${data.image}`} alt='NoImage'></img></td>
                                    <td className='p-[30px] text-center'><Link to="/admin/deletebooks"><img src='/images/deleteicon.png' alt='NoImage'></img></Link></td>
