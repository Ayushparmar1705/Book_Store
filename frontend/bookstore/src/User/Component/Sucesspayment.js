    ...
    <div className='mt-[10px]'>
      <div>
        ...
        {orders.map((data, index) => (
          ...
          <div key={index} className='shadow-xl w-[500px] text-center m-[auto]'>
            ...
            <div className='p-[10px] w-[100%] h-[500px] text-center'>
...

              {
                items.map((data) => (
                  ...
                  <div className='p-[10px] bg-lightgreen-50 rounded-[10px]'>

                    <p className='p-[10px]'>{data.name} * {data.quantity}</p>
                    <p className='p-[10px] border-b-[2px] border-gray-500'>{data.price}</p>
                    </div>
                  </>
